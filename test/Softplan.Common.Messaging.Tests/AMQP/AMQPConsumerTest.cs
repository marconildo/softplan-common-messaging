...
namespace Softplan.Common.Messaging.Tests.AMQP
{
    public class AmqpConsumerTest
    {
        ...
        private readonly AmqpConsumer _consumer;
        ...
        public AmqpConsumerTest()
        {
            ...
            _consumer = new AmqpConsumer(_channelMock.Object, _publisherMock.Object, _builderMock.Object, _managerMock.Object);              
        ...
        {
            var consumer = new AmqpConsumer(_channelMock.Object,_publisherMock.Object, _builderMock.Object, _managerMock.Object);
        ...
        {            
            ...
            action.Should()
                ...
                .WithMessage(Resources.ConsumerJainiciado);
        }
        ...
        public void When_Start_Consumer_Without_Queue_Should_Return_Expected_Exception()
        {
            ...
            action.Should()
                ...
                .WithMessage($"{Resources.NomedaFilaNaoInformado}\nParameter name: queue");
        } 
        ...
        {
            Action action = () => new AmqpConsumer(model, publisher, builder, manager);
